            ...
            <div class="col-lg-8 col-md-8">
                <div class="about-home-block">
                    ...
                    <ul>
                        ...
                        <li><a href="#" title="about">{{ __('Facilitator') }}: @if(isset($course->user)) <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" title="{{ __('instructor')}}"> {{ $course->user['fname'] }} {{ $course->user['lname'] }} </a> @endif</a></li>
                            ...
                            <div class="about-home-includes-list btm-40">
                                <ul class="btm-40">
                                    @if($courseinclude->isNotEmpty())
                                        <li><span>{{ __('This Course Includes') }}</span></li>
            ...
            <div class="col-lg-8 col-md-8">
                @if($whatlearns->isNotEmpty())
                    <div class="product-learn-block">
                        <h3 class="product-learn-heading">{{ __('What You Will Learn') }}</h3>
                        <div class="row">
                ...
                <div class="course-content-block btm-30 top-20">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-8">
                            <h3 class="mt-3 mb-1">{{ __('Course Content') }}</h3>
                        </div>
                        <!--
                ...
                <div class="requirements">
                    <h3>{{ __('Requirements For This Course') }}</h3>
                    <ul>
                        <li class="comment more">
