			            	...
			            	<div class="row btm-10">
			            		...
			            		<div class="col-lg-9 col-8">
			            			<ul>
										...
										<li class="checkout-course-user">{{ __('Bkash Charge') }}<span class="ml-3">&#2547; {{ price_format($bkash_charge) }}  </span></li>

										<li class="cart-total-two mt-2"><b>{{ __('Total') }}:<span class="ml-3">&#2547; {{ price_format($cart_total) }}  </span> </b></li>
			            			</ul>
			            		</div>
			            	</div>
	            		@endforeach
	            ...
	            <div class="col-lg-8 col-sm-8">
	            	<div class="checkout-pricelist">
		            	<ul>
		            		...
		            		<li><div class="checkout-percent pb-2 font-weight-bold">{{ round($offer_percent, 0) }}% Off</div></li>
							      ...
							      <div class="card-body">
							        ...
							        <div class="payment-proceed-btn">
										...
										<div class="d-flex flex-column">
											<span>Step you should follow</span>
											<img class="img-fluid" src="{{ url('images/manualpayment/bkash.jpg') }}" alt="">
										</div>
								        <form action="{{ route('manualpay.checkout') }}" method="POST" enctype="multipart/form-data">
				                            ...
				                            <div class="form-group">
									            <small>* If money transfer is successfull, You will receive a message from Bkash. In the message you will find a TRXIDXXXXXXX like this. Bellow the Input carefully fill the trx_id.</small>
				                                <input type="text" class="form-control w-50" name="trx_no" placeholder="Enter TRX no" required />
									          	<br>
												@error('trx_no')
