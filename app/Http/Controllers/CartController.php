...
class CartController extends Controller
{
    ...
    public function addtocart(Request $request)
    {
        ...
        return redirect()->route('cart.show')->with('success', trans('flash.CartAddedWithLink', ['cartLink' => route('cart.show')])); // hmd
        }
    ...
    public function cartpage(Request $request)
    {
        ...
        if(Auth::check())
        {
            ...
            if ($cartitems != NULL){
                ...
                // Add Bkash cash out Charge

                $bkash_charge = round(($cart_total / 100) * 1.85, 0); 

                $cart_total = $cart_total + $bkash_charge;
        ...
        return view('front.cart',compact('course', 'carts', 'wishlist','offer_total','bkash_charge','price_total', 'offer_percent', 'cart_total', 'cpn_discount', 'ad', 'item'));
