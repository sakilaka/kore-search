			                            ...
			                            <div class="cart-actions float-right">
		                                    <span>
		                                    	<form id="cart-form" method="post" action="{{url('removefromcart', $cart->id)}}" 
					    	                      ...
					    	                      <button  type="submit" class="cart-remove-btn display-inline text-danger" title="Remove From cart">{{ __('Remove	') }}</button>
					    	                    </form>
											</span>
											{{-- <span>
		                	...
		                	<div class="cart-total">
			                    ...
			                    <div class="cart-price-detail">
			                		...
			                		<ul>
			                            ...
			                            <li>{{ __('Bkash Charge') }}<span class="categories-count">&#2547; {{ price_format($bkash_charge) }}  </span></li>
			                            <hr>
			                     		...
			                     		@else
				                     		...
				                     		@if(auth::check())
												...
												@php
													...
													session()->put('bkash_charge',$bkash_charge);
