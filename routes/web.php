...
// Route::get('sign-up', [RegisterController::class, 'sign_up_view']);
// Route::post('sign-up', [RegisterController::class, 'sign_up']);

Route::get('company-register', 'Auth\CompanyRegisterController@companyRegister')->name('company_register');
Route::post('company-register/store', 'Auth\CompanyRegisterController@companyRegisterStore')->name('company_register.store');

Route::get('company-login', 'Auth\CompanyRegisterController@companyLogin')->name('company_login');
Route::post('company-login', 'Auth\CompanyRegisterController@companyLoginStore')->name('company_login.store');
Route::post('logout', 'Auth\CompanyRegisterController@logout')->name('logout');
...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware(['switch_languages', 'ip_block'])->group(function () {
        ...
        Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
            ...
            Route::middleware(['is_admin'])->group(function () {
                ...
                Route::get('jobs/all', 'Admin\JobController@index');
                Route::get('jobs/create', 'Admin\JobController@create');
                Route::post('jobs/store', 'Admin\JobController@store');
        ...
        Route::middleware(['admin_instructor', 'auth'])->group(function () {
            ...
            Route::post('page-bulk-delete', 'PageController@bulk_delete')->name('page.bulk.delete');
            Route::get('page-status', 'PageController@status')->name('page.status');
    ...
    Route::middleware(['is_verified', '2fa', 'maintanance_mode', 'switch_languages'])->group(function () {
        ...
        //Jobs Routes
        Route::get('/job/{id}', 'JobsController@index')->name('job.show');
        Route::get('/apply/{user_id}/{job_id}', 'JobsController@applyJobs')->name('apply.job');
