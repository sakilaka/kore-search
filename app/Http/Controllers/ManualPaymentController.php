...
class ManualPaymentController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        $request->validate([
            'trx_no' => 'required|between:10,10'
        ],[
            'trx_no.between' => "Enter Only 10 Character"
        ]);

        // $txn_id = str_random(8);
        $trx_id = $request->trx_no;
        ...
        return $checkout->orderstore($trx_id, $payment_method, NULL, NULL, $payment_status);
