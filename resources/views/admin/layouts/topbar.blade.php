    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="mobile-logobar">
                <a href="{{ url('/') }}" class="mobile-logo"><img
                        src="{{ url('images/favicon/' . $gsetting->favicon) }}" class="img-fluid" alt="logo"></a>
            </div>
                    ...
                    <li class="list-inline-item">
                        <div class="menubar">
                            <a class="menu-hamburger" href="javascript:void();">
                                <img src="{{ url('admin_assets/assets/images/svg-icon/menu.svg') }}"
                                    class="img-fluid menu-hamburger-collapse" alt="collapse">
                                <img src="{{ url('admin_assets/assets/images/svg-icon/close.svg') }}"
                    ...
                    <div class="togglebar">
                        <div class="breadcrumbbar">
                            ...
                            <div class="breadcrumb-list">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">{{ __('Dashboard') }}</a>
                                    </li>
                                    @if (isset($title))
                            ...
                            <li class="mt-2 mr-2 list-inline-item">
                                <div class="languagebar">
                                    <a href="{{ url('/') }}" target="_blank"><span
                                            class="live-icon">{{ __('Visit Site') }}</span>&nbsp;<i
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-toggle infobar-icon" href="#" role="button"
                                                ...
                                                aria-expanded="false"><img
                                                    src="{{ url('admin_assets/assets/images/svg-icon/notifications.svg') }}"
                                                    class="img-fluid" alt="notifications">
                                                <span
                                                    class="live-icon">{{ Auth()->user()->unreadNotifications->where('type', 'App\Notifications\AdminOrder')->count() }}</span></a>
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    @foreach (Auth()->user()->unreadNotifications->where('type', 'App\Notifications\AdminOrder') as $notification)
                                                        ...
                                                        <li class="media dropdown-item">
                                                            ...
                                                            <span
                                                                class="mr-3 action-icon badge badge-warning-inverse"><?php echo $i; ?></span>
                                                            <div class="media-body">
                                                                <a href="#">
                                                                    <p><span
                                                                            class="timing">{{ $notification->data['data'] }}</span>
                                                                    </p>
                                                                </a>
                                                            </div>
                                                        </li>
                                ...
                                <div class="profilebar">
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" id="profilelink"
                                            ...
                                            <span class="live-icon">{{ __('Hi') }}
                                                {{ Auth::user()->fname }}</span><span
                                            ...
                                            <div class="userbox">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="media dropdown-item">
                                                        <a href="{{ url('user/edit/' . Auth()->User()->id) }}"
                                                            class="profile-icon"><img
                                                                src="{{ url('admin_assets/assets/images/svg-icon/crm.svg') }}"
                                                                class="img-fluid"
                                                    ...
                                                    document.getElementById('logout-form').submit();"><img
                                                                src="{{ url('admin_assets/assets/images/svg-icon/logout.svg') }}"
                                                                class="img-fluid"
