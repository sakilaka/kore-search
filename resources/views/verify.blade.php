              ...
              <span class="text-danger">{{Session::get('vrfy_error');}}</span>
               ...
               <form action="{{url('verifycode')}}" id="stepvform" method="POST" class="needs-validation" novalidate>                  
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                      <label for="validationCustom01">Envato Domain Name:</label>
                      <input name="domain" type="text" class="form-control" id="validationCustom01" placeholder="Domain Name" value="" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                      <div class="invalid-feedback">
