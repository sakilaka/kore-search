                ...
                <tr>
                    <td class="class-type">
                        @if($class->type =='video' && $class->video )
                          <a href="{{ route('watchcourseclass',$class->id) }}" title="Course" class="@if($z == 0)iframe @endif"><i class="fa fa-play-circle"></i>&nbsp;{{ __('Lecture') }}</a>
                        @endif
                    ...
                    <td class="class-size txt-rgt">
                        ...
                        @if($class->file != NULL)
                        (pdf <a href="{{ asset('files/class/material/'.$class->file) }}" download="{{$class->file}}" title="{{ __('Learning Material')}}"><i class="fa fa-download"></i></a>)
                        @endif
                    </td>
                </tr>
            </tbody>
